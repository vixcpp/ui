/**
 *
 *  @file android_project_fixture.cpp
...
int main(int argc, char **argv)
{
  if (argc != 2)
  {
    std::cerr << "Usage: ui_android_project_fixture <output-directory>\n";
    return 2;
  }

  vix::ui::MobileConfig config;
  config.set_name("Vix Android CI")
      .set_app_id("com.vixcpp.androidci")
      .set_version("1.0.0")
